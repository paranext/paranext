...
4. Change the branch name for each repository in your `productInfo.json` to the branch name of the release of that repository you want to include in the release for this product.
   ...
   - For example, you can change the core repository's branch to a tag called `v1.2.3` by adding the `branch` property to the `coreRepo` object:

     ```json
     "coreRepo": {
       "uri": "https://github.com/paranext/paranext-core.git",
       "branch": "v1.2.3"
     }
     ```
